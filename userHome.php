              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                    The reason for the evolution of North Indian cuisine particularly in Delhi being the capital city of the country, is because foreign tourists are always visiting this place.” Tandoor, which a few years back was known to the Muslims and Punjabi community, is today the preferred cuisine among Indians and the foreigners.
                    </p>
                    <div class="btn-box">
                      <a href="usermenu.php" class="btn1">
                        Order Now
                      </a>
                    </div>
                  </div>
  ...
  <section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li data-filter=".South Indian">South Indian</li>
        <li data-filter=".North Indian">North Indian</li>
        <li data-filter=".Your Choice">Your Choice</li>
        <li data-filter=".Beverage">Beverage</li>
      </ul>

      <div class="filters-content">
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all North Indian">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all South Indian">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all Your Choice">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all Beverage">
            <div class="box">
              <div>
                <div class="img-box">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
            The college canteen being a part and parcel of college life serves a crucial role in the lives of students and faculties. The cafeteria aims to put its sole effort in improving the health condition of the students and faculty members. It also saves the time spent on travelling off campus in search of eateries. 
            </p>
            <a href="">
              Read More
            </a>
