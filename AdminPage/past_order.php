...
-->
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="../userHome.php" >Home</a></li>
                            <li class="scroll-to-section"><a href="../usermenu.php" >Menu</a></li>
                            <li class="scroll-to-section"><a href="../userabout.php" >About</a></li>
                            <li class="nav-item">
                <a class="nav-link" href="../profile.php"class="active"><?php echo $_SESSION['username'];?></a>
              </li>
                        <!-- 
                            <li class="submenu">
                        ...
                        -->
                           ...
                           <!-- <li class="scroll-to-section"><a href="Orders.html">Orders</a></li> -->
                           <!-- <li class="submenu">
    ...
    <?php 
      ...
      $key=substr($user_id,3,10);


      $order_query = "SELECT * FROM bill_info WHERE ORD_ID LIKE '%$key' order by ORD_ID DESC";
