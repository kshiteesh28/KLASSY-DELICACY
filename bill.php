<?php
    ...
    foreach($_SESSION['cart'] as $key => $value)
    {
        ...
        $query    = "INSERT into order_info(ord_id,food_id,food_name,quantity,price) VALUES ('$ord_id','$food_id','$food_name','$quantity','$price')";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                    ...
                    <tr>
                        <td align="center" style="padding: 35px 35px 20px 35px; background-color: #ffffff;" bgcolor="#ffffff">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                <tr>
                                    <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;"  width="125" height="120" style="display: block; border: 0px;" /><br>
                                        <h2 style="font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;"> Please wait while the chef goes through your order </h2>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" style="padding: 25px 0 15px 0;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 5px;" bgcolor="#66b3b7"> <a href="confirmation.php" target="_self" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: #222831; padding: 15px 30px; border: 1px solid #222831; display: block;">Check order status</a> </td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
